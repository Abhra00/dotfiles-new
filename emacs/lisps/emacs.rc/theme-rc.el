...
(defun rc/apply-everforest-style ()
  ...
  (setopt modus-themes-italic-constructs t
          ...
          `((accent-0                      "#7FBBB3")
            ...
            (green-cooler                  "#8DA683")
            (green-faint                   "#869B7C")
            (green-intense                 "#B8D48B")
            (yellow                        "#DBBC7F")
            (yellow-warmer                 "#E9C189")
            (yellow-cooler                 "#C5B873")
            (yellow-faint                  "#B8A272")
            (yellow-intense                "#F0D197")
            (blue                          "#7FBBB3")
            (blue-warmer                   "#8FB5C9")
            (blue-cooler                   "#6EB4B8")
            (blue-faint                    "#6A9A95")
            (blue-intense                  "#93CCC5")
            (magenta                       "#D699B6")
            (magenta-warmer                "#E0A0BF")
            (magenta-cooler                "#C189B5")
            (magenta-faint                 "#B37F9A")
            (magenta-intense               "#EAB0CD")
            (cyan                          "#83C092")
            (cyan-warmer                   "#92CDA0")
            (cyan-cooler                   "#73B4A3")
            (cyan-faint                    "#6EA081")
