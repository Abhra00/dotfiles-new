...
swayimg.text.set_font("Space Mono")
swayimg.text.set_size(24)
swayimg.text.set_padding(10)
swayimg.text.set_foreground(0xffefd5c5) -- fg
swayimg.text.set_background(0x00232025) -- bg
swayimg.text.set_shadow(0xff232025) -- bg-main
...
swayimg.viewer.set_window_background(0xff232025) -- bg
swayimg.viewer.set_image_chessboard(20, 0xff322f34, 0xff2e2a31) -- bg-dim / bg-popup
swayimg.viewer.enable_centering(true)
swayimg.viewer.enable_loop(true)
swayimg.viewer.limit_preload(1)
swayimg.viewer.set_mark_color(0xffefd5c5) -- fg
...
swayimg.gallery.set_border_color(0xffffaacf) -- magenta
swayimg.gallery.set_selected_scale(1.15)
swayimg.gallery.set_selected_color(0xff2e2a31) -- bg-popup
swayimg.gallery.set_unselected_color(0xff232025) -- bg-main
swayimg.gallery.set_window_color(0xff232025) -- bg-main
