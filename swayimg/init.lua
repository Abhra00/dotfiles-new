...
swayimg.text.set_foreground(0xffbbc2cf) -- fg
swayimg.text.set_background(0x00282c34) -- bg
swayimg.text.set_shadow(0xff1B2229) -- base0
...
swayimg.viewer.set_window_background(0xff282c34) -- bg
swayimg.viewer.set_image_chessboard(20, 0xff3f444a, 0xff23272e) -- base4 / base3
swayimg.viewer.enable_centering(true)
swayimg.viewer.enable_loop(true)
swayimg.viewer.limit_preload(1)
swayimg.viewer.set_mark_color(0xffbbc2cf) -- fg
...
swayimg.gallery.set_border_color(0xff51afef) -- blue
swayimg.gallery.set_selected_scale(1.15)
swayimg.gallery.set_selected_color(0xff23272e) -- base3
swayimg.gallery.set_unselected_color(0xff282c34) -- bg
swayimg.gallery.set_window_color(0xff1B2229) -- base0
