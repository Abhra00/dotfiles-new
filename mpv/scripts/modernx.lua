...
local jumpicons = {
	[5] = { "󱇹", "󱇸" }, -- skip back / forward 5
	[10] = { "󰴪", "󰵱" }, -- skip back / forward 10
	[30] = { "󰶖", "󰴆" }, -- skip back / forward 30
	default = { "󰒫", "󰒬" }, -- generic jump (mirrored in layout)
}

local icons = {
	previous = "󰒮", -- step backward
	next = "󰒭", -- step forward
	play = "󰐊",
	pause = "󰏤",
	backward = "󰑟", -- rewind
	forward = "󰈑", -- fast-forward
	audio = "󰕾",
	volume = "󰕾",
	volume_mute = "󰖁",
	sub = "󰨖", -- subtitles / captions
	minimize = "",
	fullscreen = "",
	info = "󰋼",
}
...
local osc_styles = {
	TransBg = "{\\blur100\\bord150\\1c&H261B1A&\\3c&H261B1A&}", -- #1a1b26 in BGR
	SeekbarBg = "{\\blur0\\bord0\\1c&H68413B&}", -- #3b4168 (lighter bg) in BGR
	SeekbarFg = "{\\blur1\\bord1\\1c&HF7A27A&}", -- #7aa2f7 (blue) in BGR
	VolumebarBg = "{\\blur0\\bord0\\1c&H68413B&}",
	VolumebarFg = "{\\blur1\\bord1\\1c&HF7A27A&}", -- #7aa2f7 (blue) in BGR
	Ctrl1 = "{\\blur0\\bord0\\1c&HA9B1D6&\\3c&HA9B1D6&\\fs36\\fnmaterial-design-iconic-font}", -- #a9b1d6 (fg) in BGR
	Ctrl2 = "{\\blur0\\bord0\\1c&HA9B1D6&\\3c&HA9B1D6&\\fs24\\fnmaterial-design-iconic-font}",
	Ctrl2Flip = "{\\blur0\\bord0\\1c&HA9B1D6&\\3c&HA9B1D6&\\fs24\\fnmaterial-design-iconic-font\\fry180",
	Ctrl3 = "{\\blur0\\bord0\\1c&HA9B1D6&\\3c&HA9B1D6&\\fs24\\fnmaterial-design-iconic-font}",
	Time = "{\\blur0\\bord0\\1c&HF5CAC0&\\3c&H261B1A&\\fs17\\fn" .. user_opts.font .. "}", -- #c0caf5 in BGR
	Tooltip = "{\\blur1\\bord0.5\\1c&HF5CAC0&\\3c&H261B1A&\\fs18\\fn" .. user_opts.font .. "}",
	Title = "{\\blur1\\bord0.5\\1c&HF5CAC0&\\3c&H261B1A&\\fs38\\q2\\fn" .. user_opts.font .. "}",
	WinCtrl = "{\\blur1\\bord0.5\\1c&HA9B1D6&\\3c&H261B1A&\\fs20\\fnmpv-osd-symbols}",
	elementDown = "{\\1c&H68413B&}", -- darker when pressed
	elementHighlight = "{\\blur1\\bord1\\1c&HF7A27A&}", -- #7aa2f7 blue highlight in BGR
}
